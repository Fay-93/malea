...
<head>
    ...
    <title>Admin-Posts Malea coiffure</title>
...
<div class="container">
<h1><span class="monBlog">Anciens posts</h1>
</div>
<div class="cherche">
    <table>
        <tr>
            <td class="tab">Title</td>
            <td ><a href="modifier.html"><i class="fa-solid fa-pencil"></i></a></td>
            <td><a href="supprimer.html"><i class="fa-solid fa-trash"></i></a></td>
        </tr>
        <tr>
            <td class="tab">Title</td>
            <td ><a href="modifier.html"><i class="fa-solid fa-pencil"></i></a></td>
